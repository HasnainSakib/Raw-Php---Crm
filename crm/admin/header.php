			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="../customer-list.php"><i class="fa fa-users fa-fw"></i> Customer List</a></li>
						<li><a href="admin/orders.php"><i class="fa fa-rocket fa-fw"></i> Ordersv</a></li>
						<li><a href="#"><i class="fa fa-envelope fa-fw"></i> Feedback</a></li>
						<li><a href="#"><i class="fa fa-list fa-fw"></i> Invoice</a></li>
						<li><a href="#"><i class="fa fa-money fa-fw"></i> Due Payments</a></li>
						<li><a href="#"><i class="fa fa-cubes fa-fw"></i> Services</a></li>
