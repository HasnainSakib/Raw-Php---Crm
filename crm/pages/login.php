	...
	if(isset($_POST['register'])) {
		if($_POST['password'] == $_POST['confirm']) {
			if(get_total_rows('users', "username = '".$_POST['email']."'") == 0){
				...
				// $fields['status'] = $conn->real_escape_string($_POST['status']);
				$fields['status'] =  1 ;
				
				$sql = InsertInTable('users', $fields);
				if($conn->query($sql)) {
					$sms_text = "Thanks for joining Flashnet - Broadband & Telecom Internet Provider and Welcome !\n";
					...
					header('Location: '.$base.'my-account/?new&update_profic=1&smsg='.urlencode('Registration Successfull. Thank you for registration !'));
...
<html lang="en">
  <head> 
		...
		<title>Register || Flashnet - Broadband & Telecom Internet Provider</title>
		<style>
			body {
				overflow-x: hidden;
			}
		...
		<div class="container register">
			...
			<div class="row">
				<div class="col-md-3 register-left d-none d-sm-block">
						<h3>Welcome</h3>
						<p>Flashnet - Broadband Internet Provider</p>
						<a href="../home/"><input type="submit" name="" value="Home"/><br/></a>
				</div>
				<div class="col-md-9 register-right">
					<ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="register-tab" data-toggle="tab" href="#register" role="tab" aria-controls="profile" aria-selected="true">Registration</a>
						</li>
						<li class="nav-item">
								...
								<div class="row register-form">
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<label for="term-and-condition" class="list-inline"> I accept <a href="http://dhakasolution.com/Term-Condition.html">Terms And Coditions</a></label>
										</div>
